#### This is the accompanying resources for the *Code Cool Stuff in Python* book If there are any links that are dead or changed, create an issue or a pull request.  ####
----------------------------------------------------------
