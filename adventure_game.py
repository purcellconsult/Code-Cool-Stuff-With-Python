...
# asks them additional questions, and then modifies the
...
def ask_gender():
    def male_adventure():
        ...
        if have_allies == 'y' and have_enemies == 'y':
            ...
            kingdom safe forever. The entire kingdom of {2} lived happily ever after :-).True Story.THE END.""".format(your_name, queen_name,
            ...
            message = """
                        ...
                        and usurped {0} and {1}. THE END :-(""".format(your_name, queen_name,                                                           kingdom, villian, thief, evil_sorcerer, rogue, kingdom, war_name, years)
            print(message)
